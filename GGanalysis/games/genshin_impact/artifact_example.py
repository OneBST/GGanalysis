...
print(flower.repeat(100, p=1).score_dist.dist)
print('在祝圣秘境获取100件圣遗物后，其中特定套装的生之花的最高分数的分布')
print(flower.repeat(100, p=1/10).score_dist.dist)
# 使用「祝圣之霜」自定义双暴副词条生之花
defined_flower = GI.GenshinDefinedArtifact('flower', 'hp', ['cr', 'cd'])
print('使用「祝圣之霜」自定义一次双暴副词条生之花，得到分数的分布')
print(defined_flower.score_dist.dist)
