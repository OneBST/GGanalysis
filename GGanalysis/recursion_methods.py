...
class GeneralCouponCollection():
    ...
    '''
    def __init__(self, p_list: Union[list, np.ndarray], item_name: list[str]=None) -> None:
        # 输入合法性检查
        if len(p_list) >= 16:
